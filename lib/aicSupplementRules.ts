...
export function runAICSupplementRules(
  ...
  // 2. Leaky Gut Care — gut lining powder (use with Colostrum or alone if mild)
  ...
  // 3. IBS Care — spore probiotics + motility enzymes
  ...
  // 4. Opti Fiber — prebiotic fibre for dysbiosis + constipation
  ...
  // 5. Happy Bowels — pro-kinetic laxative for constipation + SIBO
  ...
  // 6. Toxin Cleanse — binder for TMAO/toxins
  ...
  // 7. Vitamin C Care — antioxidant + immune + detox foundation
  ...
  // 8. Gut Cleanse Care — berberine for bacterial pathogens
  ...
  // 9. H Pylori Care — targeted H. pylori protocol
  if (hasHPylori) {
  ...
  // 10. Biofilm Care — biofilm disruption for resistant infections
  ...
  // 11. Lyme Co Care — parasitic/multi-infection
  if (hasParasitic) {
    needsDieOff           = true
    needsInfectionControl = true
  ...
  // 12. Parasitic Care — alternative liquid tincture for parasites
  ...
  // 13. Opti Parasitic Cleanse — capsule alternative for parasites
  if (hasParasitic) {
  ...
  // 14. Opti-Candida — enzyme-based Candida disruption
  if (hasCandida) {
    needsDieOff = true
  ...
  // 15. Active Garlic — SIBO / systemic infection / cardiovascular
  ...
  // 16. Optizyme — systemic enzyme for inflammation + biofilm
  ...
  // 18. Optibiotic — spore-based SCFA + butyrate
  ...
  // 19. Candida Care — broad-spectrum probiotic for Candida + lactobacillus depletion
  ...
  // 20. Complete Biotic Care — pre+pro+postbiotic for broad restoration
  ...
  // 21. Spore Probiotic Care — acid-resistant spores for severe depletion
  ...
  // 22. Total Active B Complex — B vitamin deficiency
  if (bVits.length >= 3) {
  ...
  // 23. Brain + Heart Care — omega-3 for gut-brain axis
  ...
  // 24. Vegan Omega 3 — plant-based Omega-3 alternative
  ...
  // 25. ZMAG — zinc + magnesium for mineral absorption
  ...
  // 26. Optimal Magnesium Care — magnesium powder for sleep + constipation
  ...
  // 27. Opt Histamine — histamine management
  if (histLow || histHigh) {
  ...
  // 28. Opti Allergy Shield — anti-histamine for allergies + die-off
  ...
  // 29. Opti Calm — anxiety + sleep + mood
  ...
  // 30. Cell Membrane Care — phospholipids for brain + mitochondria
  ...
  // 31. FMN Mito-I Support — mitochondrial energy production
  ...
  // 32. FMN Mito-II Support — mitochondrial anti-inflammatory
  ...
  // 33. FMN Opti-Zinc — zinc deficiency
  ...
  // 34. MultiVitamin MultiNutrient — broad nutritional base
  ...
  // 35. Advance Immune Care — immune boosting
  ...
  // 36. Heart Care — cardiovascular + mitochondrial
  ...
  // 37. UTI Care — urinary tract infections (female patients)
  ...
  // 38. Pain Care — anti-inflammatory for pain + fatigue
  ...
  // 39. Opti-Age — anti-ageing + longevity
  ...
  // 40. FMN Assimilate — protein + phospholipid nutrition
  ...
  // 41. Opti-Glutathione Complex — standard glutathione + liver support
  ...
  // 42. Lipo-Glutathione — high-dose liposomal glutathione
  ...
  // 43. System Detox Care — EDTA chelation for heavy metals
  ...
  // 44. Heavy Metal Detox — zeolite + humic acid binder
  ...
  // 45. Opti-Green — chlorella + spirulina detox
  ...
  // 46. Opti-Bile — liver + gallbladder TUDCA
  ...
  // 47. Opti-Liver — liver protection
  ...
  // 48. Opti-Silica — hair/skin/nail/heavy metal
  ...
  // 49. Activated Charcoal — die-off binder
  if (needsDieOff || tmao) {
  ...
  // 50. FMN Chlorella — powder detox support
  if (tmao || oxStress || needsDieOff) {
  ...
  // 51. Digest All Care — full enzyme replacement
  ...
  // 52. Veg Digest All Care — vegan enzyme alternative
  ...
  // 53. Pancreatic Multi-enzyme Care — comprehensive pancreatic support
  ...
  // 54. Gerd Care — betaine HCL for low stomach acid
  ...
  // 55. Wheat Digest Care — gluten intolerance
  ...
  // 56. Dairy Digest Care — lactose intolerance
  ...
  // 57. Eczema Care — candida enzyme for skin
  ...
  // 58. Creatine Monohydrate — muscle + cognitive support
  ...
  // 59. Detoxamin EDTA Suppository — advanced chelation
  ...
  // 60. Detoxamin EDTA + Glutathione Suppository — combined chelation
